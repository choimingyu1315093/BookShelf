...
class VPAdapter4(private val fragment: Fragment, private val onClickListener: ProfileMemoFragment.OnDetailListener): FragmentStateAdapter(fragment) {
    ...
    override fun createFragment(position: Int): Fragment {
        if(position == 0){
            ...
            return ProfileMemoFragment(onClickListener)
        }
    }
}