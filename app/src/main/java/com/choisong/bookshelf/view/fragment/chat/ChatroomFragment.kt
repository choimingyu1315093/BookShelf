...
@AndroidEntryPoint
class ChatroomFragment : Fragment(), ChatMessageAdapter.OnClickChatListener, DeleteChatroomDialog.OnChatroomOutListener {
    ...
    private val name: ChatroomFragmentArgs by navArgs()
    ...
    private fun bindViews() = with(binding){
        txtOut.setOnClickListener {
            val dialog = DeleteChatroomDialog(chatroomIdx.chatroomIdx, this@ChatroomFragment)
    ...
    private var onChatInfo: Emitter.Listener = Emitter.Listener { args ->
        ...
        requireActivity().runOnUiThread(Runnable {
            ...
            Log.d(TAG, "onChatInfo jsonObject $jsonObject")
